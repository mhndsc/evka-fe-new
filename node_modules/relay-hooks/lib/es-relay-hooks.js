import { __internal, createOperationDescriptor, getRequest, ConnectionInterface, getDataIDsFromFragment, getVariablesFromFragment, getSelector, getFragmentIdentifier, getFragment, commitMutation, requestSubscription } from 'relay-runtime';
export { applyOptimisticMutation, commitLocalUpdate, commitMutation, fetchQuery, graphql, requestSubscription } from 'relay-runtime';
...
var ReactRelayContext = createRelayContext(React);
...
export { FORWARD, FRAGMENT_NAME, NETWORK_ONLY, PAGINATION_NAME, REFETCHABLE_NAME, ReactRelayContext, RelayEnvironmentProvider, STORE_ONLY, STORE_OR_NETWORK, STORE_THEN_NETWORK, loadLazyQuery, loadQuery, useFragment, useLazyLoadQuery, useMutation, useOssFragment, usePagination, usePaginationFragment, usePreloadedQuery, useQuery, useRefetchable, useRefetchableFragment, useRelayEnvironment, useSubscription, useSuspenseFragment };
//# sourceMappingURL=es-relay-hooks.js.map
